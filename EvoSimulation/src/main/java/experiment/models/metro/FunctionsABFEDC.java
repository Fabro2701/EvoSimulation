...
public class FunctionsABFEDC {
      ...
      public static void CAction78(Entity e) {
      ...
      public static boolean transition91(Entity e) {
            return e.getAttribute("current").equals("D");
      }
      public static boolean transition92(Entity e) {
