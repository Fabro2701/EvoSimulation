...
/*
 * public class AttributesPanel extends javax.swing.JPanel { private Controller
 * ctrl;
 * 
 * public AttributesPanel() { initComponents(); ctrl = new Controller();
 * modificationPanel.setViewportView(ctrl.img); }
 * 
 * public class Controller implements MouseListener,MouseMotionListener{ private
 * HashMap<String,Attribute> models; private Graphics2D bufferGraphics; private
 * BufferedImage bufferImage; private int strokeSize; private int intensity;
 * private Attribute selection; private int width, height; private
 * ModificationImage img;
 * 
 * private Point current; public Controller() { width = 800; height = 800;
 * 
 ...
 * Color(0,0,0)); bufferGraphics.fillRect(0, 0, width, height);
 * 
 * img = new ModificationImage(new ImageIcon(bufferImage), this); //img = new
 * ModificationImage(new ImageIcon("resources/maps/test1.jpg"), this);
 * //img.setIcon(new ImageIcon("resources/maps/elevation1test.jpg"));
 * 
 * 
 * models = new HashMap<String,Attribute>(); models.put("Temperature", new
 * Attribute(new Color(255,0,0,100),width, height)); models.put("Radiation", new
 * Attribute(new Color(0,255,0,100),width, height)); selection =
 * models.get("Temperature");
 * 
 * current = new Point(); } public void setSelection(String stringKey) {
 * //System.out.println(stringKey); selection=models.get(stringKey); } public
 * void setStrokeSize(int value) { strokeSize = value; } public void
 * setIntensity(int value) { intensity = value; } public class Attribute{
 * private Color color; private BufferedImage ownImage; private Graphics2D
 * ownGraphics; public Attribute(Color c, int width, int height) { color = c;
 * ownImage = new BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB);
 * ownGraphics = ownImage.createGraphics(); } private void paint(Point p1, Point
 * p2, int strokeSize, int intensity, Graphics2D bufferGraphics) {
 * ownGraphics.setStroke(new BasicStroke(strokeSize)); ownGraphics.setColor(new
 * Color(255,0,0,intensity)); ownGraphics.drawLine(p1.x,p1.y,p2.x,p2.y);
 * 
 * bufferGraphics.setStroke(new BasicStroke(strokeSize));
 * bufferGraphics.setColor(new
 * Color(color.getRed(),color.getGreen(),color.getBlue(),intensity));
 * bufferGraphics.drawLine(p1.x,p1.y,p2.x,p2.y); } }
 * 
 * @Override public void mouseClicked(MouseEvent e) {}
 * 
 * @Override public void mousePressed(MouseEvent e) { // TODO Auto-generated
 * method stub current.setLocation(e.getPoint());
 ...
 * 
 * public class ModificationImage extends JLabel implements Scrollable{ public
 ...
 * new javax.swing.JSlider(); jLabel3 = new javax.swing.JLabel(); jsIntensity =
 * new javax.swing.JSlider(); jScrollPane2 = new javax.swing.JScrollPane();
 * jPanel2 = new javax.swing.JPanel();
 * 
 ...
 * "Temperature", "Radiation" })); jComboBox1.addActionListener(new
 ...
 * jLabel3.setText("Intensity");
 * 
 * jsIntensity.setMinimum(1); jsIntensity.addChangeListener(new
 * javax.swing.event.ChangeListener() { public void
 * stateChanged(javax.swing.event.ChangeEvent evt) {
 * jsIntensityStateChanged(evt); } });
 * 
 ...
 * javax.swing.GroupLayout.PREFERRED_SIZE)) .addComponent(jsStrokeSize,
 * javax.swing.GroupLayout.Alignment.LEADING,
 * javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
 * Short.MAX_VALUE) .addComponent(jLabel3,
 * javax.swing.GroupLayout.Alignment.LEADING,
 * javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
 * Short.MAX_VALUE) .addComponent(jsIntensity,
 * javax.swing.GroupLayout.Alignment.LEADING,
 * javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
 ...
 * javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
 * .addComponent(modificationPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 710,
 * Short.MAX_VALUE))
 * .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
 * .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.
 ...
 * jsIntensity; private javax.swing.JSlider jsStrokeSize; // End of variables
 * declaration }
 */
